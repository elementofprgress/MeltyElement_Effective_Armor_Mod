        ...
        public function update(width:Number, height:Number) : void
        {
            ...
            for(n in this.elements)
            {
                ...
                if(counterScale)
                {
                    ...
                    if((edges & scaleform.clik.utils.Constraints.CENTER_H) == 0)
                    {
                        if((edges & scaleform.clik.utils.Constraints.LEFT) > 0)
                        {
                            clip.x = element.left * xAdjust;
                            if((edges & scaleform.clik.utils.Constraints.RIGHT) > 0)
                            {
                        ...
                        else if((edges & scaleform.clik.utils.Constraints.RIGHT) > 0)
                        {
                            clip.x = (width - element.right) * xAdjust - clip.width;
                        }
                    }
                    if((edges & scaleform.clik.utils.Constraints.CENTER_V) == 0)
                    {
                        if((edges & scaleform.clik.utils.Constraints.TOP) > 0)
                        {
                            clip.y = element.top * yAdjust;
                            if((edges & scaleform.clik.utils.Constraints.BOTTOM) > 0)
                            {
                        ...
                        else if((edges & scaleform.clik.utils.Constraints.BOTTOM) > 0)
                        {
                ...
                {
                    if((edges & scaleform.clik.utils.Constraints.CENTER_H) == 0 && (edges & scaleform.clik.utils.Constraints.RIGHT) > 0)
                    {
                        if((edges & scaleform.clik.utils.Constraints.LEFT) > 0)
                        {
                    ...
                    if((edges & scaleform.clik.utils.Constraints.CENTER_V) == 0 && (edges & scaleform.clik.utils.Constraints.BOTTOM) > 0)
                    {
                        if((edges & scaleform.clik.utils.Constraints.TOP) > 0)
                        {
        ...
        protected function addToParentConstraints() : void
        {
            ...
            while(true)
            {
                if(p != null)
                {
                    ...
                    {
                        this.parentConstraints = p["constraints"] as scaleform.clik.utils.Constraints;
